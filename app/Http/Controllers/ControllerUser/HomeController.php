...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $historys = $viewed->getListReading('nd', 12);
        return view('user.home.index', compact('historys'));
    }
    ...
    {
        $viewed = new \App\Models\Viewed;
        $historys = $viewed->getListReading('nd');
        return view('user.auth.history', compact('historys'));
    }
}
